...
VALUES(1,'Dorstige drommedaris', 'Mechelen', 'Drinkt alles op');
INSERT INTO ANIMAL (ID, name, city, bio)
VALUES(2,'Gillende giraffe', 'Sint-Katelijne-Waver', 'Roept heel luid');
INSERT INTO ANIMAL (ID, name, city, bio)
VALUES(3, 'Domme dolfijn', 'Leuven', 'Doet veel domme dingen');
INSERT INTO ANIMAL (ID, name, city, bio)
VALUES(4, 'Sterke schildpad', 'Lier', 'Enorm sterk');

INSERT INTO PARTY_ANIMALS (PARTIES_ID, ANIMALS_ID) VALUES (1,1);
INSERT INTO PARTY_ANIMALS (PARTIES_ID, ANIMALS_ID) VALUES (1,2);
...
INSERT INTO PARTY_ANIMALS (PARTIES_ID, ANIMALS_ID) VALUES (4,2);
